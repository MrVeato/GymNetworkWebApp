...
<div class="breadcrumb-section">
    <div class="container">
        <div class="breadcrumb-wrapper">
            <div class="breadcrumb-title"><h6 class="title">Авторизація</h6></div>
            <ul class="breadcrumb">
...
<div class="container">
    <div class="login-wrapper">
        <h3 class="title">Користувач зі вказаним логіном вже існує</h3>
        <p></p>
        <a href="<c:url value="/gym/register"/>" class="title">Повернутися до форми реєстрації</a></div>
    </div>
</div>
