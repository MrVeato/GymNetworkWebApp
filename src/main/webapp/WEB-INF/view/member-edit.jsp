    ...
    <div class="container">
        <h3 class="title">
            <span class="shape-wrapper">
                <span class="shape"></span>Мій спортклуб<span class="shape"></span></span>
        </h3>
    </div>
</section>
        ...
        <div class="row">
                ...
                <div>
                    <div class="col-lg-10">
                        <div class="expert-single-content"><h3 class="title">Мій профіль</h3><br>
                            ...
                            <div><h5>Оновити інформацію</h5><br>
                                ...
                                <form:form action="/gym/dashboard/profile" method="post" modelAttribute="user" class="registration-form">
                                    ...
                                    <div class="col-lg-4">
                                        <input type="submit" value="Save" class="m-0"/></div>
                                </form:form>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4">
                <aside class="sidebar">
                    ...
                    <div class="widget widget-category widget-info"><h5 class="widget-title">Створені плани</h5>
                        <ul>
                            ...
                            <a href="<c:url value="/gym/plans"/>"><b><i>ПРИДБАТИ ПАН ТРЕНУВАНЬ</i></b></a>
                        </ul>
                    </div>
                    <div class="widget widget-category widget-info"><h5 class="widget-title">Мої тренування</h5>
                        <ul>
                            <li><a href="#">Формування </a></li><br>
