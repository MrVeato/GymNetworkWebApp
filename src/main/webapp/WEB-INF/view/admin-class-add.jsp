            ...
            <div class="form-row">
                <div class="value">
                    ...
                    <form:select path="day">
                        <form:option value = "Понеділок">Понеділок</form:option>
                        <form:option value = "Вівторок">Вівторок</form:option>
                        <form:option value = "Середа">Середа</form:option>
                        <form:option value = "Четвер">Четвер</form:option>
                        <form:option value = "Пятниця">Пятниця</form:option>
                        <form:option value = "Субота">Субота</form:option>
                        <form:option value = "Неділя">Неділя</form:option>
                    </form:select>
                ...
                <div class="value col-lg-2">
                    <div class="value">
                        <label>Час</label>
                        <form:input path="hour" type="text" placeholder="ГГ:ХХ"/>
...
<%--                        <form:option value = "-- Wybierz z listy --"></form:option>--%>
            ...
            <p></p>
            <div class="col-lg-3">
                <input type="submit" class="register-btn" value="Save"/>
                <p></p>
            </div>
            <div class="form-row">
                <div class="col-lg-3">
                    <input type="button" class="custom-button-plan"
                           onclick="location.href='/admin/schedule';" value="Go back"/>
                </div>
            </div>
        </div>
    </div>
