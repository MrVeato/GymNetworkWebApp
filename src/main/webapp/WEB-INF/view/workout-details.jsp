    ...
    <div class="container">
        <h3 class="title">
            <span class="shape-wrapper">
                <span class="shape"></span>Мій план<span class="shape"></span></span>
        </h3>
    </div>
</section>
...
<div class="breadcrumb-section">
    <div class="container">
        <div class="breadcrumb-wrapper">
            <div class="breadcrumb-title"><h6 class="title">Тренування</h6></div>
            <ul class="breadcrumb">
...
<div class="padding-bottom padding-top bg_img" data-background="/static/images/banner/wall.jpg">
    <div class="container">
        <div class="login-wrapper">
            <h3 class="title">Мої тренування</h3>
            ...
            <div class="form-group"><h4>${workout.name}</h4>
                <br><br><b>
                <div class="form-group"> ЦІЛЬ: ${workout.type}</div>
                <div class="p-t-15"><b></b>
                </div>
                <br>
                <p><b>Кількість підходів: ${workout.sets}</p>
                <p><b>Кількість повторень: ${workout.reps}</p>
                <br>
                <div class="form-group">ВПРАВИ</div>
                <ul>
            ...
            <br>
            <div class="col-lg-6">
                <input type="submit" class="register-btn" value="Видалити план"/>
