        ...
        <div class="row">
            <div class="col-lg-6 traning-info">
                ...
                <div class="trainer-description">
                    З дитинства любив спорт і не любив програвати. 13 років в спортивно-бальних танцях, фітнесі та всіх ігрових видах спорту. Брав участь у Всеукраїнських змаганнях і чемпіонатах України з бальних танців, учасник і презентер фітнес-олімпіад і конвенцій.

                    Перетанцює, накачає та зарядить енергією будь-якого!
                </div>
            </div>
            <div class="col-lg-6 trainer-image top-trainer">
                <img class="img-responsive" src="/static/images/trainers/trainer3.jpg" alt="">        </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
