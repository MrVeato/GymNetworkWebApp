...
import diploma.company.service.PlanOrderService;
import diploma.company.service.PlanService;
import diploma.company.service.TrainerService;
...
public class PlanOrderController {
	...
	public String processPayment(@PathVariable Long id, @Valid @ModelAttribute PlanOrder planOrder, BindingResult result){
		...
		return "redirect:https://www.paypal.com/ua/signin";
	}
}
